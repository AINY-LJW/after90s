...
import com.after90s.common.utils.TreeUtils;
import com.after90s.core.project.menu.domin.MenuEntity;
import com.after90s.core.project.menu.mapper.MenuMapper;
import com.after90s.core.project.role.domin.RoleEntity;
import com.after90s.core.project.role.mapper.RoleMenuMapper;


/**
 * <p>TODO 菜单相关Service</p>
 *
 * @author LJW
 * @version 2019年7月19日
 */
...
public class MenuServiceImpl implements IMenuService{
    ...
    {
        List<MenuEntity> menus = menuMapper.selectMenusByUserId(userId);
    ...
    public List<Map<String, Object>> roleMenuTreeData(RoleEntity role)
    {
        ...
        List<MenuEntity> menuList = menuMapper.selectMenuAll();
    ...
    public LinkedHashMap<String, String> selectPermsAll()
    {
        ...
        List<MenuEntity> permissions = menuMapper.selectMenuAll();
        if (StringUtils.isNotEmpty(permissions))
        {
            for (MenuEntity menu : permissions)
            {
     ...
     * @return
     */
    public List<Map<String, Object>> getTrees(List<MenuEntity> menuList, boolean isCheck, List<String> roleMenuList,
            boolean permsFlag)
    {
        List<Map<String, Object>> trees = new ArrayList<Map<String, Object>>();
    ...
    public String transMenuName(MenuEntity menu, List<String> roleMenuList, boolean permsFlag)
    {
    ...
    public String checkMenuNameUnique(MenuEntity menu)
    {
        ...
        Long menuId = menu.getMenuId();
        MenuEntity info = menuMapper.checkMenuNameUnique(menu.getMenuName());
