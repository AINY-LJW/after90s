...
import com.after90s.frame.shiro.filter.MyLogoutFilter;
import com.after90s.frame.shiro.filter.OnlineSessionFilter;
import com.after90s.frame.shiro.filter.SyncOnlineSessionFilter;
import com.after90s.frame.shiro.realm.UserRealm;
import com.after90s.frame.shiro.session.OnlineSessionDAO;
import com.after90s.frame.shiro.session.OnlineSessionFactory;
import com.after90s.frame.web.session.OnlineWebSessionManager;
...
//        filterChainDefinitionMap.put("/login", "captchaValidate");
        // 系统权限列表
...
//    }
    ...
    {
    	//避免与SERVLET容器（如JETTY, TOMCAT）默认的Cookie名冲突：JSESSIONID
